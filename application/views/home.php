...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="<?= base_url('assets/') ?>assets/assets/favicon.ico" />
    ...
    <body>
        <!-- Background Video-->
        <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="<?= base_url('assets/') ?>assets/assets/mp4/bg.mp4" type="video/mp4" /></video>
        <!-- Masthead-->
        <div class="masthead">
        ...
        <?php if ($this->session->flashdata('success-logout')) : ?>
                <script>
                    Swal.fire({
                        ...
                        text: 'Silakan login kembali untuk mengakses dashboard!',
