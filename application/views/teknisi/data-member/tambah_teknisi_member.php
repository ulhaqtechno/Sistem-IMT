                ...
                <div class="form-group ">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" autocomplete="off" name="uid" id="nama_file" placeholder="No ID kartu member .." required>
                      ...
                      ?>
                        <option value="<?php echo $u->code_instansi ?>"><?php echo $u->instansi ?></option>
                        <?php
                      }
                      ?>
                      </select>
