...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?= base_url('teknisi/teknisi/dashboard') ?>" target="_blank">
        <img src="<?= base_url('assets/') ?>img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">IMT</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6"><?= $user['jenis'] ?></h6>
        </li>

        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'dashboard' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('teknisi/teknisi/dashboard') ?>">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'data_user_teknisi' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('teknisi/teknisi/data_user_teknisi') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'data_instansi_teknisi' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('teknisi/teknisi/data_instansi_teknisi') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'data_member_teknisi' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('teknisi/teknisi/data_member_teknisi') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'data_imt_teknisi' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('teknisi/teknisi/data_imt_teknisi') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
