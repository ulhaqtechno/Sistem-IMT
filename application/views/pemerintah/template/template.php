...
<!-- sidebar -->
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?= base_url('pemerintah/pemerintah/dashboard') ?>" target="_blank">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'dashboard' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('pemerintah/pemerintah/dashboard') ?>">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'data_user_pemerintah' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('pemerintah/pemerintah/data_user_pemerintah') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $this->uri->segment(3) == 'data_imt_pemerintah' || $this->uri->segment(3) == '' ? 'active' : '' ?>" href="<?= base_url('pemerintah/pemerintah/data_imt_pemerintah') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
