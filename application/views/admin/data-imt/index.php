              ...
              <div class="col-sm-12">
                    <div class="bg-white p-4" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
                      ...
                      ?>
                          ...
                          <td class="align-middle text-center">
                            <a href="<?php echo site_url('admin/change/data_imt_teknisi/detail_teknisi_imt/' . $u->id); ?>" class="btn btn-link text-success text-gradient px-3 mb-0">Detail ⭢</a>

                              <!-- <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="<?php echo site_url('teknisi/change/data_imt_teknisi/delete_teknisi_imt/' . $uid->id); ?>"><i class="far fa-trash-alt me-2"></i></a>

                              <a class="btn btn-link text-dark px-3 mb-0" href="<?php echo site_url('teknisi/change/data_imt_teknisi/update_teknisi_imt/' . $u->id); ?>"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i></a> -->
                          </td>
                        </tr>
                        <?php endif; ?>
                      <?php
