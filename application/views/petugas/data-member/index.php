                    ...
                    <table id="example" class="table align-items-center table-flush">
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="align-middle text-center">
                            <a href="<?php echo site_url('petugas/change/data_member_teknisi/detail_teknisi_member/' . $u->id); ?>" class="btn btn-link text-success text-gradient px-3 mb-0">Detail ⭢</a>

                              <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="<?php echo site_url('petugas/change/data_member_teknisi/delete_teknisi_member/' . $u->id); ?>"><i class="far fa-trash-alt me-2"></i></a>

                              <a class="btn btn-link text-primary px-3 mb-0" href="<?php echo site_url('petugas/change/data_member_teknisi/update_teknisi_member/' . $u->id); ?>"><i class="fas fa-pencil-alt text-primary me-2" aria-hidden="true"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
